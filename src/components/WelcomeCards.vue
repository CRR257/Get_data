<template>
  <div class="container">
    <ul class="projects">
      <li v-for="project in projects" :key="project" class="projects-cards">
        <div class="project" @click="goto(project.route)">
    ...
    return {
      projects: [
        ...
        },
        {
          ...
          route: "/planets-survey"
        },
        {
          title: "Bitcoin",
          about: "Bitcoin prices, updated every minute",
          route: "/bitcoin"
        },
        {
          title: "Weather",
